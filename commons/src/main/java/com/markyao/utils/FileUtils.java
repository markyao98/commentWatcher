...
//    public final static String staticPath=FileUtils.class.getClassLoader().getResource("static").getPath()+"/"+"imgs/";
    public final static String staticPath="E:\\study_daydayup\\project\\douyin-harvest\\myself\\comments-watcher\\app-show\\target\\classes\\static\\imgs";
...
//        copyImageFile(sPath,dPath);
        copyImageFile(sPath,staticPath+"66216064194842624.png");
    }

package com.markyao.service.harvest.core;
...
import static com.markyao.service.harvest.impl.RequestURLServiceImpl.STOP_HARVEST_URL;
...
public class HarvestCommentWorker {
  ...
  public static LinkedHashMap<String, Object> getStringObjectLinkedHashMap(String response) throws IOException, ParseException {
     ...
     * @param aid
     */
    public void start0(String aid) throws IOException, ParseException {
        int cur=0;
        while (!stateMap.containsKey(STOP_HARVEST_URL)){
            ...
            commentService.harvestComments(response);
